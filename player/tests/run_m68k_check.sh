...
# coeff/mvpred/mbinfo/mbparse/intramb timing build (ih264d_cabac_wrap.c's
# C trampoline, ih264d_parse_cabac_coeff_port.c's, ih264d_mvpred_dispatch_
# port.c's, ih264d_mbinfo_wrap_port.c's and ih264d_intramb_wrap_port.c's
...
# export, no C trampoline at all, and no __wrap_ih264d_get_mb_info_cabac_
# nonmbaff/__wrap_ih264d_parse_imb_cabac linked in at all - is what
