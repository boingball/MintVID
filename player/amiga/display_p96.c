...
/*
 * Mode picking itself (BestCModeIDTags scoring, native-or-downscale policy)
 * now lives in rtg_mode_pick.c, shared with display_cgx.c's own private
 * screen - see rtg_mode_pick.h for the policy this implements and why.
 */
