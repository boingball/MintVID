...
/* MintVID adaptation: this vendored copy has no installed <libdv/...>
 * include path - dv_types.h lives alongside this file. */
#include "dv_types.h"
...
/* MintVID adaptation: `pitches` narrowed from `int *` to `uint16_t *` to
 * match what the YV12 planar renderer this build actually uses
 * (dv_mb420_YV12(), YV12.h) declares and reads - see dv.c's own note by
...
extern void         dv_decode_full_frame(dv_decoder_t *dv,
					  ...
					  uint8_t **pixels, uint16_t *pitches);
