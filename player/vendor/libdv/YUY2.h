...
/* scalar versions */
/* MintVID adaptation: dv_mb411_YUY2()/dv_mb411_right_YUY2()'s `pitches`
 * narrowed from `int *` to `uint16_t *` - see YUY2.c. */
extern void dv_mb411_YUY2(dv_macroblock_t *mb, uint8_t **pixels, uint16_t *pitches, int add_ntsc_setup);
extern void dv_mb411_right_YUY2(dv_macroblock_t *mb, uint8_t **pixels, uint16_t *pitches, int add_ntsc_setup);
