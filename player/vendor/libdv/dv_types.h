...
#include <stdio.h>
#include <time.h>
/* MintVID adaptation: see mr_dv_endian.h - this replaces the HAVE_ENDIAN_H/
 * HAVE_MACHINE_ENDIAN_H autoconf-detected <endian.h> include, which is never
 * available in this buildless vendor copy. */
